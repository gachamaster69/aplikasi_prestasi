...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Prestasi Non Akademik</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
...
<script>
    $(".delete").click(function () {
        ...
        swal({
            title: "Anda Yakin?",
            text:
                "Akan menghapus prestasi dengan nama " +
                prestasinama +
                " ",
            icon: "warning",
            buttons: true,
            ...
            if (willDelete) {
                window.location = "/deleteprestasinonakademik/" + prestasiid + "";
